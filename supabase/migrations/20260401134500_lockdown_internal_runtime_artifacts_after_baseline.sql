...
revoke all on function public.set_runtime_settings_updated_at() from anon, authenticated;
grant execute on function public.set_runtime_settings_updated_at() to service_role;

revoke all on table public.internal_secrets from anon, authenticated;
