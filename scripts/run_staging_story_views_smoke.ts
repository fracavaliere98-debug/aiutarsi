...
export async function runStagingStoryViewsSmoke(mode: "idempotence" | "cross_device" | "full" = "full") {
...
if (import.meta.main) {
  const modeArg = (process.argv[2] as "idempotence" | "cross_device" | "full" | undefined) || "full";
