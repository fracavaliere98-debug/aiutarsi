...
// Load env vars
// Note: In this environment, we might need hardcoded credentials if .env is tricky, 
// but we'll try standard loading first or fallback.
...
async function testCreateActivity() {
    ...
    const { data, error } = await supabase
        ...
        .insert({
            npo_id: userId,
            title: "Test Activity RLS",
            description: "Debugging RLS policies",
