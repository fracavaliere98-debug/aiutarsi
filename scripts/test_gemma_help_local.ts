...
const cases = [
  ...
  {
    name: 'Volunteer Gemma capabilities direct',
    role: 'VOLUNTEER',
    context: volunteerContext,
    question: 'Cosa puoi fare?',
    history: [],
    includes: ['Posso aiutarti', 'AiutarSì'],
  },
  {
    name: 'Volunteer activity search how-to',
    role: 'VOLUNTEER',
    context: volunteerContext,
    question: "Come trovo un'attività?",
    history: [],
    includes: ['Esplora', 'Mappa'],
  },
  {
    name: 'Volunteer activity search follow-up',
    role: 'VOLUNTEER',
    context: volunteerContext,
    question: 'Come le cerco?',
    history: ["Come trovo un'attività?"],
    includes: ['Esplora', 'Mappa'],
  },
  {
