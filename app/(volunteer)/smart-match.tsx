    ...
    return (
        <ScreenWrapper edges={['top']} bg="bg-white" withPadding={false}>
            <ScrollView contentContainerStyle={{ paddingHorizontal: 20, paddingTop: 12, paddingBottom: 36 }}>
                ...
                {isLoading ? (
                    <Text style={{ color: colors.textSecondary, fontSize: 14 }}>Gemma sta aggiornando i suggerimenti…</Text>
                        ...
                        return (
                            ...
                            >
                                <View style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', marginBottom: 10 }}>
                                    ...
                                    <Text style={{ color: colors.textSecondary, fontSize: 12, fontWeight: '700' }}>{match.score}%</Text>
                                </View>

                                <Text style={{ color: colors.textSecondary, fontSize: 11, fontWeight: '700', letterSpacing: 0.4, textTransform: 'uppercase', marginBottom: 4 }}>
                                    {activity.npoName}
                                </Text>
                                ...
                                <View style={{ flexDirection: 'row', gap: 8, flexWrap: 'wrap' }}>
                                    ...
                                    <TouchableOpacity onPress={() => hideMatch(match)} style={{ flexDirection: 'row', alignItems: 'center', gap: 5, backgroundColor: '#f8fafc', borderRadius: 999, paddingHorizontal: 12, paddingVertical: 8 }}>
                                        ...
                                        <Text style={{ color: colors.textSecondary, fontSize: 12, fontWeight: '700' }}>Nascondi</Text>
                                    </TouchableOpacity>
                                </View>
                            </TouchableOpacity>
                        );
