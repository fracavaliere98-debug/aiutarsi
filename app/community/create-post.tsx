...
import { ArrowLeft, Image as ImageIcon, X, Link2 } from 'lucide-react-native';
        ...
        <View style={{ flex: 1, backgroundColor: '#f8fafc' }}>
            <SafeAreaView edges={['top']}>
                <View style={{ flexDirection: 'row', alignItems: 'center', paddingHorizontal: 16, paddingVertical: 14, backgroundColor: 'white', borderBottomWidth: 1, borderBottomColor: '#f1f5f9' }}>
                    ...
                    <Text style={{ flex: 1, fontSize: 18, fontWeight: '900', color: Colors.primary }}>Nuovo Post Community</Text>
                    <TouchableOpacity
