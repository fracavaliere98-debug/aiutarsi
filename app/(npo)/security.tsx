...
export default function SecurityScreen({ onClose }: { onClose?: () => void }) {
    ...
    return (
        <StandardLayout title="Credenziali Accesso" label="Sicurezza" onBack={onClose ? onClose : () => router.back()}>
            ...
            <SoftCard className="p-5 mb-6">
                <PasswordInput label="Password Attuale" value={currentPassword} onChangeText={setCurrentPassword} showPassword={showPassword} setShowPassword={setShowPassword} />
                <PasswordInput label="Nuova Password" value={newPassword} onChangeText={setNewPassword} showPassword={showPassword} setShowPassword={setShowPassword} />
            ...
            <View className="absolute bottom-6 left-6 right-6">
                ...
                >
                    ...
                    <Text className="text-white font-black text-lg">
                        {isLoading ? "Aggiornamento..." : "Aggiorna Credenziali"}
                    </Text>
                </TouchableOpacity>
            </View>
        </StandardLayout>
