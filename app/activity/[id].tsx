    ...
    return (
        <View style={{ flex: 1, backgroundColor: 'white' }}>
            ...
            {isOldAndroid ? (
                ...
                >
                    <View style={{ width: '100%', height: 250, backgroundColor: '#f0f0f0' }}>
                        <Image
                    ...
                    <View style={{ paddingHorizontal: 20, paddingTop: 20 }}>
                        {/* Status Badge */}
                        <View className="flex-row items-center gap-2 mb-4 bg-slate-100 self-start px-3 py-1.5 rounded-full">
                            <View className={`w-2 h-2 rounded-full ${activity?.status === "IN_CORSO" ? "bg-amber-500" :
